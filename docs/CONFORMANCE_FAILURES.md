...
**Round 91**: 18 PASS, 16 FAIL | **122 fixes**
...
| 3 | builder.go:97 | kubectl content type | Discovery/OpenAPI content negotiation |
...
**13 of 16 FIXED** pending deploy. 3 remaining: #1 watch timing, #3 kubectl OpenAPI, #11 SA timing, #15 deployment revision.
