...
**Last updated**: 2026-03-19 (after fixes round 4)
...
| 20 | Aggregated discovery format | ~1 | pending |
| 21 | Ephemeral container PATCH route | ~1 | pending |
| 22 | NodePort MASQUERADE rules | ~3 | pending |

## Cannot Fix (infrastructure/design limitations)

| # | Issue | Tests | Reason |
|---|-------|-------|--------|
| A | CRD protobuf creation | ~3 | Need protobuf support |
...
| # | Issue | Tests | Notes |
|---|-------|-------|-------|
| D | DNS resolution | ~2 | CoreDNS integration |
| E | Pod startup timeouts | varies | Container networking |
