...
async fn apply_resource(client: &ApiClient, value: &serde_yaml::Value) -> Result<()> {
    ...
    match kind {
        "Pod" => {
            ...
            let exists = resource_exists::<Pod>(
                client,
        ...
        "Service" => {
            ...
            let exists = resource_exists::<Service>(
                client,
        ...
        "Deployment" => {
            ...
            let exists = resource_exists::<Deployment>(
                client,
                &format!(
        ...
        "StatefulSet" => {
            ...
            let exists = resource_exists::<StatefulSet>(
                client,
                &format!(
        ...
        "DaemonSet" => {
            ...
            let exists = resource_exists::<DaemonSet>(
                client,
        ...
        "Node" => {
            ...
            let exists =
                resource_exists::<Node>(client, &format!("/api/v1/nodes/{}", name)).await?;
        ...
        "Namespace" => {
            ...
            let exists =
                resource_exists::<Namespace>(client, &format!("/api/v1/namespaces/{}", name))
                    .await?;
        ...
        "Job" => {
            ...
            let exists = resource_exists::<Job>(
                client,
            ...
            if exists {
                ...
                let _result: Job = client
                    .post(
                        &format!("/apis/batch/v1/namespaces/{}/jobs", namespace),
                        &job,
                    )
                    .await?;
        ...
        "CronJob" => {
            ...
            let exists = resource_exists::<CronJob>(
                client,
        ...
        "PersistentVolume" => {
            ...
            let exists = resource_exists::<PersistentVolume>(
                client,
            ...
            if exists {
                ...
                let _result: PersistentVolume =
                    client.post("/api/v1/persistentvolumes", &pv).await?;
        ...
        "PersistentVolumeClaim" => {
            ...
            let exists = resource_exists::<PersistentVolumeClaim>(
                client,
                &format!(
        ...
        "StorageClass" => {
            ...
            let exists = resource_exists::<StorageClass>(
                client,
        ...
        "VolumeSnapshot" => {
            ...
            let exists = resource_exists::<VolumeSnapshot>(
                client,
                &format!(
        ...
        "VolumeSnapshotClass" => {
            ...
            let exists = resource_exists::<VolumeSnapshotClass>(
                client,
                &format!(
            ...
            if exists {
                let _result: VolumeSnapshotClass = client
                    ...
                    .await?;
                println!(
                    "volumesnapshotclass.snapshot.storage.k8s.io/{} configured",
                    name
                );
            } else {
                ...
                let _result: VolumeSnapshotClass = client
                    ...
                    .await?;
                println!(
                    "volumesnapshotclass.snapshot.storage.k8s.io/{} created",
                    name
                );
            }
        }
        "Endpoints" => {
            ...
            let exists = resource_exists::<Endpoints>(
                client,
                &format!("/api/v1/namespaces/{}/endpoints/{}", namespace, name),
            )
            .await?;
        ...
        "ConfigMap" => {
            ...
            let exists = resource_exists::<ConfigMap>(
                client,
        ...
        "Secret" => {
            ...
            let exists = resource_exists::<Secret>(
                client,
        ...
        "Ingress" => {
            ...
            let exists = resource_exists::<Ingress>(
                client,
                &format!(
        ...
        "ServiceAccount" => {
            ...
            let exists = resource_exists::<ServiceAccount>(
                client,
        ...
        "Role" => {
            ...
            let exists = resource_exists::<Role>(
                client,
                &format!(
        ...
        "RoleBinding" => {
            ...
            let exists = resource_exists::<RoleBinding>(
                client,
                &format!(
        ...
        "ClusterRole" => {
            ...
            let exists = resource_exists::<ClusterRole>(
                client,
        ...
        "ClusterRoleBinding" => {
            ...
            let exists = resource_exists::<ClusterRoleBinding>(
                client,
                &format!(
            ...
            if exists {
                let _result: ClusterRoleBinding = client
                    ...
                    .await?;
                println!(
                    "clusterrolebinding.rbac.authorization.k8s.io/{} configured",
                    name
                );
            } else {
        ...
        "ResourceQuota" => {
            ...
            let exists = resource_exists::<ResourceQuota>(
                client,
                &format!("/api/v1/namespaces/{}/resourcequotas/{}", namespace, name),
            )
            .await?;
        ...
        "LimitRange" => {
            ...
            let exists = resource_exists::<LimitRange>(
                client,
                &format!("/api/v1/namespaces/{}/limitranges/{}", namespace, name),
            )
            .await?;
        ...
        "PriorityClass" => {
            ...
            let exists = resource_exists::<PriorityClass>(
                client,
                &format!("/apis/scheduling.k8s.io/v1/priorityclasses/{}", name),
            )
            .await?;
        ...
        "CustomResourceDefinition" => {
            ...
            let exists = resource_exists::<CustomResourceDefinition>(
                client,
                &format!(
            ...
            if exists {
                let _result: CustomResourceDefinition = client
                    ...
                    .await?;
                println!(
                    "customresourcedefinition.apiextensions.k8s.io/{} configured",
                    name
                );
            } else {
